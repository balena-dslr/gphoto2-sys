use libc::{c_char, c_int, c_uchar, c_ulong, c_void, size_t, time_t};

// TODO: should be *const c_char
pub const GP_MIME_WAV: &[u8] = b"audio/wav\0";
pub const GP_MIME_RAW: &[u8] = b"image/x-raw\0";
pub const GP_MIME_PNG: &[u8] = b"image/png\0";
pub const GP_MIME_PGM: &[u8] = b"image/x-portable-graymap\0";
pub const GP_MIME_PPM: &[u8] = b"image/x-portable-pixmap\0";
pub const GP_MIME_PNM: &[u8] = b"image/x-portable-anymap\0";
pub const GP_MIME_JPEG: &[u8] = b"image/jpeg\0";
pub const GP_MIME_TIFF: &[u8] = b"image/tiff\0";
pub const GP_MIME_BMP: &[u8] = b"image/bmp\0";
pub const GP_MIME_QUICKTIME: &[u8] = b"video/quicktime\0";
pub const GP_MIME_AVI: &[u8] = b"video/x-msvideo\0";
pub const GP_MIME_CRW: &[u8] = b"image/x-canon-raw\0";
pub const GP_MIME_CR2: &[u8] = b"image/x-canon-cr2\0";
pub const GP_MIME_UNKNOWN: &[u8] = b"application/octet-stream\0";
pub const GP_MIME_EXIF: &[u8] = b"application/x-exif\0";
pub const GP_MIME_MP3: &[u8] = b"audio/mpeg\0";
pub const GP_MIME_OGG: &[u8] = b"application/ogg\0";
pub const GP_MIME_WMA: &[u8] = b"audio/x-wma\0";
pub const GP_MIME_ASF: &[u8] = b"audio/x-asf\0";
pub const GP_MIME_MPEG: &[u8] = b"video/mpeg\0";
pub const GP_MIME_AVCHD: &[u8] = b"video/mp2t\0";
pub const GP_MIME_RW2: &[u8] = b"image/x-panasonic-raw2\0";
pub const GP_MIME_ARW: &[u8] = b"image/x-sony-arw\0";
...
pub const GP_FILE_ACCESSTYPE_MEMORY: CameraFileAccessType =
    CameraFileAccessType::GP_FILE_ACCESSTYPE_MEMORY;
pub const GP_FILE_ACCESSTYPE_FD: CameraFileAccessType = CameraFileAccessType::GP_FILE_ACCESSTYPE_FD;
pub const GP_FILE_ACCESSTYPE_HANDLER: CameraFileAccessType =
    CameraFileAccessType::GP_FILE_ACCESSTYPE_HANDLER;

extern "C" {
    pub fn gp_file_new(file: *mut *mut CameraFile) -> c_int;
    pub fn gp_file_new_from_fd(file: *mut *mut CameraFile, fd: c_int) -> c_int;
    pub fn gp_file_new_from_handler(
        file: *mut *mut CameraFile,
        handler: *mut CameraFileHandler,
        prv: *mut c_void,
    ) -> c_int;
    ...
    pub fn gp_file_set_data_and_size(
        file: *mut CameraFile,
        data: *mut c_char,
        size: c_ulong,
    ) -> c_int;
