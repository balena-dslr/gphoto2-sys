...
pub const GP_DRIVER_STATUS_PRODUCTION: CameraDriverStatus =
    CameraDriverStatus::GP_DRIVER_STATUS_PRODUCTION;
pub const GP_DRIVER_STATUS_TESTING: CameraDriverStatus =
    CameraDriverStatus::GP_DRIVER_STATUS_TESTING;
pub const GP_DRIVER_STATUS_EXPERIMENTAL: CameraDriverStatus =
    CameraDriverStatus::GP_DRIVER_STATUS_EXPERIMENTAL;
pub const GP_DRIVER_STATUS_DEPRECATED: CameraDriverStatus =
    CameraDriverStatus::GP_DRIVER_STATUS_DEPRECATED;
