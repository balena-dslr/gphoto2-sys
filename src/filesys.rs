...
pub const GP_STORAGEINFO_ST_UNKNOWN: CameraStorageType =
    CameraStorageType::GP_STORAGEINFO_ST_UNKNOWN;
pub const GP_STORAGEINFO_ST_FIXED_ROM: CameraStorageType =
    CameraStorageType::GP_STORAGEINFO_ST_FIXED_ROM;
pub const GP_STORAGEINFO_ST_REMOVABLE_ROM: CameraStorageType =
    CameraStorageType::GP_STORAGEINFO_ST_REMOVABLE_ROM;
pub const GP_STORAGEINFO_ST_FIXED_RAM: CameraStorageType =
    CameraStorageType::GP_STORAGEINFO_ST_FIXED_RAM;
pub const GP_STORAGEINFO_ST_REMOVABLE_RAM: CameraStorageType =
    CameraStorageType::GP_STORAGEINFO_ST_REMOVABLE_RAM;
...
pub const GP_STORAGEINFO_FST_UNDEFINED: CameraStorageFilesystemType =
    CameraStorageFilesystemType::GP_STORAGEINFO_FST_UNDEFINED;
pub const GP_STORAGEINFO_FST_GENERICFLAT: CameraStorageFilesystemType =
    CameraStorageFilesystemType::GP_STORAGEINFO_FST_GENERICFLAT;
pub const GP_STORAGEINFO_FST_GENERICHIERARCHICAL: CameraStorageFilesystemType =
    CameraStorageFilesystemType::GP_STORAGEINFO_FST_GENERICHIERARCHICAL;
pub const GP_STORAGEINFO_FST_DCF: CameraStorageFilesystemType =
    CameraStorageFilesystemType::GP_STORAGEINFO_FST_DCF;
...
pub const GP_STORAGEINFO_AC_READWRITE: CameraStorageAccessType =
    CameraStorageAccessType::GP_STORAGEINFO_AC_READWRITE;
pub const GP_STORAGEINFO_AC_READONLY: CameraStorageAccessType =
    CameraStorageAccessType::GP_STORAGEINFO_AC_READONLY;
pub const GP_STORAGEINFO_AC_READONLY_WITH_DELETE: CameraStorageAccessType =
    CameraStorageAccessType::GP_STORAGEINFO_AC_READONLY_WITH_DELETE;
