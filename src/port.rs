...
extern "C" {
    ...
    pub fn gp_port_info_list_lookup_path(list: *const GPPortInfoList, path: *const c_char)
        -> c_int;
    pub fn gp_port_info_list_lookup_name(list: *const GPPortInfoList, name: *const c_char)
        -> c_int;
    pub fn gp_port_info_list_get_info(
        list: *const GPPortInfoList,
        n: c_int,
        info: *mut GPPortInfo,
    ) -> c_int;
